...
#can we access set elements by index   -- NO
# set1 = {"a","b","c","d"}
...
# for x in range(len(set2)):            #start index = 0 endindex =9 stepsize = 1
#     print(x)    

#list
list1 = [10,20,30,40,50]
for x in range(len(list1)):      #start index = 0 endindex =9 stepsize = 1
    #print(x)
    print(list1[x])
